    ...
    _createClass(NumberEditor, [{
        ...
        value: function _onBlur(e) {
            if (this.state.startEditing) {
                ...
                if (!isNaN(Number(this.state.localValue))) this._changeValue(Number(this.state.localValue));else this.setState({ localValue: this.props.value });
            }
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(_textField2.default, {
                ...
                style: (0, _Object2.default)(this.props.style, { cursor: cursor, textAlign: "center" }),
                inputStyle: (0, _Object2.default)(this.props.style, { cursor: cursor, textAlign: "center" }),
